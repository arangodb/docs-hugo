...
parser.add_argument('--dst', type=str,
                    help='path to save the metrics file')
...
LS_HERE = os.listdir(ARANGODB_SOURCE)
if not("arangod" in LS_HERE and "client-tools" in LS_HERE and "CMakeLists.txt" in LS_HERE):
