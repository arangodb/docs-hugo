...
and [indexes](../../indexes-and-search/indexing/_index.md).
...
You can use [persistent indexes](../../indexes-and-search/indexing/working-with-indexes/persistent-indexes.md) with both date types.
