...
weight: 15
description: >-
  Find one path of shortest length or lowest weight between two nodes
---
## General query idea

This type of query finds a path between two given documents
(*startNode* and *endNode*) in your graph.
...
A top-level edge attribute to use as the weight weight (string).
