...
{{< warning >}}
In _arangosh_, when returning numeric integer values to JavaScript that leave
...
[Incompatible changes in ArangoDB 4.x](../../release-notes/version-4.x/incompatible-changes-in-4-x.md#duplicate-attribute-names-in-object-literals).
{{< /info >}}
