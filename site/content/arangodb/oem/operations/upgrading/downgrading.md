...
stopped the ArangoDB process running on it) before the upgrade. If you are running a
...
Cluster setups because in this case you do not have a copy of the data directories.
