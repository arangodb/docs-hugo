...
[API Changes in ArangoDB 3.11](api-changes-in-oem.md#cursor-api)
for details.
...
Also see:
- [API Changes in ArangoDB 3.11](api-changes-in-oem.md#explain-api)
...
See [API Changes in ArangoDB 3.11](api-changes-in-oem.md#query-api).
...
[Incompatible changes in ArangoDB 3.11](incompatible-changes-in-oem.md#write-write-conflict-improvements)
