...
See [API Changes in ArangoDB 3.11](api-changes-in-oem.md#validation-of-smartgraphattribute-in-smartgraphs)
...
See [Features and Improvements in ArangoDB 3.11](whats-new-in-oem.md#parallel-gather)
for details.
