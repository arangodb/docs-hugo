...
1. Stop ArangoDB (if you use an Active Failover, or a Cluster, stop all the needed
   processes on all the machines).
2. As extra precaution, take a backup of your current data directory (at filesystem level).
   If you use an Active Failover or a Cluster, you will need to backup all the data
...
stopped the ArangoDB process running on it) before the upgrade. If you run an Active Failover
deployment or a Cluster, this procedure assumes that you have stopped every ArangoDB process before
...
2. As extra precaution, take a backup of your data directory (at filesystem level). If
   you use an Active Failover or a Cluster, you will need to backup all the data
   directories of all the processes involved, from all machines. Make sure you move your
