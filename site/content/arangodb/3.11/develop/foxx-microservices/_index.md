...
ArangoDB's own HTTP API with custom HTTP endpoints using modern JavaScript running
...
your project's needs Foxx can be used to build anything from optimized HTTP
