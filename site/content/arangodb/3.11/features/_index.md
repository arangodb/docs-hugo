...
Special long-term support (LTS) is available for OEM / embedded use cases on request.
...
at scale. For more information, [Request a quote](https://arango.ai/request-pricing).
...
does not support the 3.11 OEM LTS version of ArangoDB.
...
While ArangoDB version 3.11 was available in a **Community Edition**, the
3.11 OEM LTS version is limited to the Enterprise Edition.
