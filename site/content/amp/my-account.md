...
5. Click the __Verify my email address__ link in the email. It takes you back
   to the Arango Managed Platform (AMP) site.
...
![Arango Managed Platform My API keys](../images/amp-api-keys.png)
...
![Arango Managed Platform New API key](../images/amp-create-new-api-key.png)
