...
are APIs for this. The first one is [Cluster Health](../../../http/cluster.md#queries-the-health-of-cluster-for-monitoring):
...
[Cluster Inventory](../../../http/replication/replication-dump.md#return-cluster-inventory-of-collections-and-indexes)
API call:
...
[re-balance](../cluster/administration.md#movingrebalancing-shards) the shard distribution,
