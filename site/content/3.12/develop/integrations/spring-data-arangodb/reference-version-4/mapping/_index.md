...
| @ComputedValueField     | field                     | marks the field for the mapping framework so that the property will be updated with the value coming from the server and optionally describes a computed value data definition |
