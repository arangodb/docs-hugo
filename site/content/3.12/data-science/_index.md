...
An experimental feature for [Graph Analytics](graph-analytics.md) to run
algorithms such as connected components, label propagation, and PageRank is
available for the ArangoGraph Insights Platform.
