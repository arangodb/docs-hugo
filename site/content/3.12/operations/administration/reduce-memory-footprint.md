...
reduce these [RocksDB settings](../../components/arangodb-server/options.md#rocksdb):
...
This option disables the in-memory index [caches](../../components/arangodb-server/options.md#cache).
