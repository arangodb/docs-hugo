...
| `strategies[].entity_types` | array | Domain-specific entity types generated by the LLM for this FullGraphRAG clusters. Empty for VectorRAG (no entity extraction needed). Passed to the Importer to constrain entity extraction (see [Per-cluster ontology](../design-guide.md#per-cluster-ontology-entity_types)). |
