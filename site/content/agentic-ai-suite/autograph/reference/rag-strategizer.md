...
| `strategies[].cluster_id` | string | Domain/cluster key (e.g. `cluster_legal_0`, or `cluster_0` when no category prefix applies). This is the value that [`PATCH /v1/rag-strategizer/strategy/{cluster_id}`](#update-a-cluster-strategy) takes. |
