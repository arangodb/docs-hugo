...
- [ArangoSearch overview](../../core-topics/indexing/arangosearch/_index.md)
- ArangoSearch in AQL:
...
For more information please refer to the [Query Profiling](../../aql/execution-and-performance/query-profiling.md)
page.
...
[arangoimport now can pace the data load rate automatically](../../core-topics/programs-and-tools/arangoimport/details.md#automatic-pacing-with-busy-or-low-throughput-disk-subsystems)
...
[Active Failover Architecture](../../advanced-topics/deployment/active-failover/_index.md).
