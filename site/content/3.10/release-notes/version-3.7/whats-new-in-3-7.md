...
weight: 5
description: >-
  ArangoDB v3.7 Release Notes New Features
archetype: default
---
...
See [ArangoSearch Views](../../core-topics/indexing/arangosearch/arangosearch-views-reference.md#view-properties).
...
Also see [Analyzers: Supported Languages](../../advanced-topics/analyzers.md#supported-languages)
...
[Disjoint SmartGraphs](../../core-topics/graphs/smartgraphs/_index.md)
are only available in the Enterprise Edition.
...
See: [Schema Validation](../../getting-started/getting-started/data-model-and-concepts/documents/schema-validation.md)
...
See: [HTTP Switching Protocols](../../http/general-request-handling.md#switch-protocols)
...
with the [Server Name Indication](../../core-topics/programs-and-tools/arangodb-server/options.md#--sslserver-name-indication)
...
This allows
[rotation of TLS keys and certificates](../../http/security.md#encryption-in-transit)
without a server restart.

### Encryption at rest key rotation (Enterprise Edition)

It is possible to change the user supplied encryption key via the
[HTTP API](../../http/security.md#encryption-at-rest)
...
The query options are available in [AQL](../../aql/high-level-operations/insert.md#query-options),
the [JS API](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#insert--save) and
[HTTP API](../../http/documents.md#create-document).
...
Also see [Pregel](../../core-topics/data-science/pregel/_index.md)
...
The [`query` helper](../../appendix/javascript-modules/arangodb.md#the-query-helper)
...
on `/_admin/metrics`.
See [Metrics HTTP API](../../http/monitoring.md#metrics).
...
- [Server environment variables](../../core-topics/programs-and-tools/arangodb-server/environment-variables.md)
