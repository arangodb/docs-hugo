...
See [Analyzers](../../advanced-topics/analyzers.md) for all available options.
...
See [Primary Sort Order](../../core-topics/indexing/arangosearch/performance.md#primary-sort-order)
...
Also see:
- [SmartJoins documentation](../../advanced-topics/smartjoins.md)
...
Also see: [Creating Indexes in Background](../../core-topics/indexing/index-basics.md#creating-indexes-in-background)
...
Also see: [TTL Indexes](../../core-topics/indexing/working-with-indexes/ttl-indexes.md)
...
Also see: [Collection Database Methods](../../getting-started/getting-started/data-model-and-concepts/collections/database-methods.md#create)
...
See:
- [Get responsible shard in JS API](../../getting-started/getting-started/data-model-and-concepts/collections/collection-methods.md#getresponsibleshard)
- [Get responsible shard in HTTP API](../../http/collections.md#return-responsible-shard-for-a-document)
...
Also see:
- [_arangodump_](../../core-topics/programs-and-tools/arangodump/_index.md)
- [_arangorestore_](../../core-topics/programs-and-tools/arangorestore/_index.md)
