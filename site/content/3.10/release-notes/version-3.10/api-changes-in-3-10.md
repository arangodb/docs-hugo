...
See [Respond to liveliness probes](../../http/general-request-handling.md#respond-to-liveliness-probes) for more details.
...
Also see [EnterpriseGraphs](../../core-topics/graphs/enterprisegraphs/_index.md).
...
Also see the [HTTP API documentation](../../http/indexes/inverted.md).
...
Also see the [HTTP API documentation](../../http/views/search-alias-views.md).

#### Computed Values

The [Computed Values](../../getting-started/getting-started/data-model-and-concepts/documents/computed-values.md) feature
...
- [`minhash`](../../advanced-topics/analyzers.md#minhash):
...
- [`classification`](../../advanced-topics/analyzers.md#classification) (experimental):
  It has three properties, `model_location` (string), `top_k` (number, optional,
  default: `1`), and `threshold` (number, optional, default: `0.99`).

- [`nearest_neighbors`](../../advanced-topics/analyzers.md#nearest_neighbors) (experimental):
...
See [Respond to liveliness probes](../../http/general-request-handling.md#respond-to-liveliness-probes) for more information.
...
[Read from followers](../../http/documents.md#read-from-followers)
for details.
...
[Pregel HTTP API](../../http/pregel.md#get-pregel-job-execution-status).
...
`computedValues` attribute. See [Computed Values](../../getting-started/getting-started/data-model-and-concepts/documents/computed-values.md#javascript-api)
for details.
...
[query spillover feature](whats-new-in-3-10.md#query-result-spillover-to-decrease-memory-usage)
and to [Read from followers](../../http/documents.md#read-from-followers):
