...
It is now possible to test [SmartGraphs](../../core-topics/graphs/smartgraphs/_index.md) and
[SatelliteGraphs](../../core-topics/graphs/satellitegraphs/_index.md) on a single server and then to
...
Also see [SmartGraphs and SatelliteGraphs on a Single Server](../../core-topics/graphs/testing-graphs-on-single-server.md).
...
See the [EnterpriseGraphs](../../core-topics/graphs/enterprisegraphs/_index.md) chapter for more details.
...
See [Computed Values](../../getting-started/getting-started/data-model-and-concepts/documents/computed-values.md) for more
...
See [Inverted index](../../core-topics/indexing/working-with-indexes/inverted-indexes.md) for details.
...
Also see [Getting started with ArangoSearch](../../core-topics/indexing/arangosearch/_index.md#getting-started-with-arangosearch).
...
See [Search highlighting with ArangoSearch](../../core-topics/indexing/arangosearch/search-highlighting.md)
for details.
...
See [Nested search with ArangoSearch](../../core-topics/indexing/arangosearch/nested-search.md) using Views
and the nested search example using [Inverted indexes](../../core-topics/indexing/working-with-indexes/inverted-indexes.md#nested-search-enterprise-edition)
for details.
...
[`arangosearch` Views](../../core-topics/indexing/arangosearch/arangosearch-views-reference.md) support new caching options.
...
See [Optimizing View and inverted index query performance](../../core-topics/indexing/arangosearch/performance.md)
for examples.
...
[UDFs](../../aql/user-functions/_index.md) runs on the server. This can be useful to close off
...
information. Also see [Listing all indexes of a collection](../../core-topics/indexing/working-with-indexes/_index.md#listing-all-indexes-of-a-collection).
...
See [Analyzers](../../advanced-topics/analyzers.md#minhash) for details.
...
See [Analyzers](../../advanced-topics/analyzers.md#classification) for details.
...
See [Analyzers](../../advanced-topics/analyzers.md#nearest_neighbors) for details.
...
See [Analyzers](../../advanced-topics/analyzers.md#geo_s2) for details.
...
and [GeoJSON Mode](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#geojson-mode).
...
See [Legacy Polygons](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#legacy-polygons) for
...
See [Lookahead Index Hint](../../core-topics/indexing/working-with-indexes/multi-dimensional-indexes.md#lookahead-index-hint).
...
See [Array Operators](../../aql/advanced-features/array-operators.md#question-mark-operator)
for details.
...
See [Persistent Indexes](../../core-topics/indexing/working-with-indexes/persistent-indexes.md#storing-additional-values-in-indexes).
...
See [Persistent Indexes](../../core-topics/indexing/working-with-indexes/persistent-indexes.md#caching-of-index-values).
...
For more information, see the [Cluster](../../http/cluster.md#compute-the-current-cluster-imbalance) 
...
For details, see:
- [`temp` startup options](../../core-topics/programs-and-tools/arangodb-server/options.md#--tempintermediate-results-path)
- [Executing queries from _arangosh_](../../aql/how-to-invoke-aql/with-arangosh.md#spilloverthresholdmemoryusage)
- [HTTP interfaces for AQL queries](../../http/queries/aql-queries.md#create-cursor)
...
For more information on the new options, please refer to [ArangoDB Server Pregel Options](../../core-topics/programs-and-tools/arangodb-server/options.md#pregel).
...
[`--arangosearch.columns-cache-only-leader` startup option](../../core-topics/programs-and-tools/arangodb-server/options.md#--arangosearchcolumns-cache-only-leader).
...
See [ArangoDB Server environment variables](../../core-topics/programs-and-tools/arangodb-server/environment-variables.md)
for details.
...
For more information, refer to the [_arangoimport_ Options](../../core-topics/programs-and-tools/arangoimport/options.md).
...
See the [Starter configuration file](../../core-topics/programs-and-tools/arangodb-starter/architecture.md#starter-configuration-file)
