...
The fulltext index type is now deprecated in favor of [ArangoSearch](../../core-topics/indexing/arangosearch/_index.md).
...
[Legacy Polygons](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#legacy-polygons) for details.
Also see the definition of [Polygons](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#polygon).
