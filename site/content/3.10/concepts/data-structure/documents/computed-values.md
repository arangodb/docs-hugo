...
- [Create a collection](../../../http/collections.md#create-a-collection),
- [Read properties of a collection](../../../http/collections.md#get-the-properties-of-a-collection),
- [Change properties of a collection](../../../http/collections.md#change-the-properties-of-a-collection).
...
- The expression must start with a `RETURN` operation and cannot contain any
  ...
  [array expansion operator `[*]`](../../../aql/advanced-features/array-operators.md#inline-expressions),
...
- You can use AQL functions in the expression but only those that can be
  ...
  - `WITHIN_RECTANGLE()`
  - `FULLTEXT()`
  - [User-defined functions (UDFs)](../../../aql/user-functions/_index.md)
