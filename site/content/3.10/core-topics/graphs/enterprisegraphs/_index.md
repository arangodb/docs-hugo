...
and [General Graph Functions](../general-graphs/graph-functions.md) sections.
...
to [Enterprise Graphs Management](enterprisegraph-management.md).

Coming from the Community Edition? 
See [how to migrate](getting-started-with-enterprisegraphs.md#migrating-from-community-edition)
from a `general-graph` to an `enterprise-graph`.

## How EnterpriseGraphs work

The creation and usage of EnterpriseGraphs are similar to [SmartGraphs](../smartgraphs/getting-started-with-smartgraphs.md).
...
EnterpriseGraphs are capable of using [SatelliteCollections](../../../advanced-topics/satellitecollections.md)
