...
collections being processed before all [edge collections](../../../getting-started/getting-started/data-model-and-concepts/_index.md#graph-model).
...
{{< tip >}}
See [Fast Cluster Restore](fast-cluster-restore.md)
