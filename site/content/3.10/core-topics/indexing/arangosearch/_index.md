...
[full-text index](../working-with-indexes/fulltext-indexes.md) type. It can index nested fields
...
- **`search-alias` Views**:
  ...
  [Inverted indexes](../working-with-indexes/inverted-indexes.md). Inverted indexes are defined on
...
The input values can be processed by so called [**Analyzers**](../../../advanced-topics/analyzers.md)
