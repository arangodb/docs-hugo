...
[Streaming Lock Timeout](../programs-and-tools/arangodb-server/options.md#--transactionstreaming-lock-timeout)),
...
- [`count()`](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#count)
- [`document()`](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#document)
- [`exists()`](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#exists)
- [`insert()`](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#insert--save)
- [`name()`](../../getting-started/getting-started/data-model-and-concepts/collections/database-methods.md#collection-name)
- [`remove()`](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#remove)
- [`replace()`](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#replace)
- [`save()`](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#insert--save)
- [`truncate()`](../../getting-started/getting-started/data-model-and-concepts/collections/collection-methods.md#truncate)
- [`update()`](../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#update)
