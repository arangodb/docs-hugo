...
using ArangoDB's command-line tool called [arangosh](../../core-topics/programs-and-tools/arangodb-shell/_index.md).
To learn more about the ways you can use and communicate with ArangoDB servers,
see [How to Interact With ArangoDB](how-to-interact-with-arangodb.md).
...
Learn more about ArangoDB's [data model and concepts](data-model-and-concepts/_index.md).
...
[Use ArangoDB in the Cloud](setting-up-a-cloud-instance.md) to get started.
