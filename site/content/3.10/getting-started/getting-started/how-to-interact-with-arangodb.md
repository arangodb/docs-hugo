...
The core component of ArangoDB is the [ArangoDB server](../../core-topics/programs-and-tools/arangodb-server/_index.md)
...
[web interface](../../core-topics/programs-and-tools/web-interface/_index.md). The ArangoDB server serves this
...
You can use [arangosh](../../core-topics/programs-and-tools/arangodb-shell/_index.md), an interactive shell that ships
with ArangoDB, and its [JavaScript API](../../appendix/references/db.md), to
