...
weight: 45
description: >-
  Creating test data, counting, subqueries, joins, grouping, traversals and other examples
archetype: chapter
---
...
- *_id*: A unique id, consisting of [collection name](../../getting-started/getting-started/data-model-and-concepts/collections/_index.md#collection-names)
...
*_id*, *_from* and *_to* attributes. Finally, [edge collections](../../getting-started/getting-started/data-model-and-concepts/_index.md#graph-model)
