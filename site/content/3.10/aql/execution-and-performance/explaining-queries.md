...
weight: 15
description: >-
  If it is unclear how a given query will perform, clients can retrieve a query's execution plan from the AQL query optimizer without actually executing the query
archetype: default
---
...
Explaining a query can be achieved by calling the [HTTP REST API](../../http/queries/aql-queries.md)
or via _arangosh_.
...
- *nodes*: the array of execution nodes of the plan. See the
  [list of execution nodes](query-optimization.md#list-of-execution-nodes)
- *estimatedCost*: the total estimated cost for the plan. If there are multiple
  plans, the optimizer will choose the plan with the lowest total cost.
- *collections*: an array of collections used in the query
- *rules*: an array of rules the optimizer applied. See the
  [list of optimizer rules](query-optimization.md#list-of-optimizer-rules)
