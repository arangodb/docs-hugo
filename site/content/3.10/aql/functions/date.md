...
and [indexes](../../core-topics/indexing/_index.md).
...
You can use [persistent indexes](../../core-topics/indexing/working-with-indexes/persistent-indexes.md) with both date types.
