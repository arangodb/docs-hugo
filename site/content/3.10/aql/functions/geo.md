...
see [Geo Indexing](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md).
...
form with an S2-based [geospatial index](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md):
...
[geo index page](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#geojson).
...
see the [geo index page](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#geojson).
...
types see the [geo index page](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#geojson).
...
For details about the rules, see [GeoJSON polygons](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#polygon).
...
See [GEO_POLYGON()](#geo_polygon) and [GeoJSON MultiPolygons](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#multipolygon) for the rules of Polygon and MultiPolygon construction.
...
[geo indexes](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md). These functions require the collection
