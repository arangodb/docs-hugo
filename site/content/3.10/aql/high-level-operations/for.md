...
There is also a special variant for [graph traversals](../../graphs/traversals/_index.md):
...
[Graph Traversals](../../graphs/traversals/_index.md#working-with-named-graphs) (Enterprise Edition only).
{{< /info >}}
