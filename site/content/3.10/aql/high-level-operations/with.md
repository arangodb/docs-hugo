...
see [Requiring `WITH` statements](../../core-topics/programs-and-tools/arangodb-server/options.md#--queryrequire-with).
...
[collection sets](../../core-topics/graphs/traversals/_index.md#working-with-collection-sets).
