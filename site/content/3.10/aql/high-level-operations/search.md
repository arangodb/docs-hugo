...
See [`arangosearch` Views](../../core-topics/indexing/arangosearch/arangosearch-views-reference.md) and
[`search-alias` Views](../../core-topics/indexing/arangosearch/search-alias-views-reference.md) on how to set up Views.
...
You can use the [Question mark operator](../advanced-features/array-operators.md#question-mark-operator)
to perform [Nested searches with ArangoSearch](../../core-topics/indexing/arangosearch/nested-search.md)
...
search using the `nested` property in [`arangosearch` Views](../../core-topics/indexing/arangosearch/arangosearch-views-reference.md#link-properties)
or in the definition of [Inverted Indexes](../../core-topics/indexing/working-with-indexes/inverted-indexes.md#nested-search-enterprise-edition)
that you can add to [`search-alias` Views](../../core-topics/indexing/arangosearch/search-alias-views-reference.md).
...
[`arangosearch` View property](../../core-topics/indexing/arangosearch/arangosearch-views-reference.md#link-properties)
...
[primary sort order](../../core-topics/indexing/arangosearch/performance.md#primary-sort-order) definition
