...
[collection name](../../getting-started/getting-started/data-model-and-concepts/collections/_index.md#collection-names) must not be dynamic.
...
When inserting into an [edge collection](../../getting-started/getting-started/data-model-and-concepts/_index.md#graph-model),
