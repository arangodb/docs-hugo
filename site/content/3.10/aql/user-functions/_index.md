...
[Coordinator](../../advanced-topics/deployment/cluster/_index.md).
...
[**cluster backend unavailable**](../../appendix/error-codes-and-meanings.md) error.

To overcome these mentioned limitations, you may want to increase the
[number of available V8 contexts](../../core-topics/programs-and-tools/arangodb-server/options.md#--javascriptv8-contexts)
(at the expense of increased memory usage), and the
[number of available server threads](../../core-topics/programs-and-tools/arangodb-server/options.md#--servermaximal-threads).
...
[arangodump](../../core-topics/programs-and-tools/arangodump/_index.md) by default.
