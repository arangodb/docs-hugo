...
[SmartGraphs](../../core-topics/graphs/smartgraphs/_index.md) that, if used while the database
...
1. Use the tool [_arangodump_](../../core-topics/programs-and-tools/arangodump/_index.md) to take a backup
...
4. Restore the backup using the tool [_arangorestore_](../../core-topics/programs-and-tools/arangorestore/_index.md).
