...
weight: 120
description: >-
  A direct, in-place downgrade of ArangoDB is not supported
archetype: default
---
...
- Restore a backup you took using the tool [_arangodump_](../core-topics/programs-and-tools/arangodump/_index.md)
  before the upgrade.
