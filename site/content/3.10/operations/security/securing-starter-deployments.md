...
- Open the ArangoDB web interface and change the password from there. [More information](../../core-topics/programs-and-tools/web-interface/users.md).
...
refer to the _Starter_ [Option](../../core-topics/programs-and-tools/arangodb-starter/options.md#authentication-options) page.
