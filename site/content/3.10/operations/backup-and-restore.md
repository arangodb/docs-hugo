...
[_arangodump_](../core-topics/programs-and-tools/arangodump/_index.md) and
...
the [Fast Cluster Restore](../core-topics/programs-and-tools/arangorestore/fast-cluster-restore.md)
...
[_arangobackup_](../core-topics/programs-and-tools/arangobackup/_index.md) client tool and the
...
- **Identical Topology**
  ...
  Unlike dumps created with [_arangodump_](../core-topics/programs-and-tools/arangodump/_index.md) and restored
  with [_arangorestore_](../core-topics/programs-and-tools/arangorestore/_index.md),
