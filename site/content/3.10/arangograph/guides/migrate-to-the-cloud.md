...
- Generate an ArangoGraph API key and API secret. See a detailed guide on 
  [how to create an API key](../api/arangograph-api/getting-started-with-the-api.md#creating-an-api-key).
...
See a detailed guide on how to [create a new certificate/keyfile pair](../../core-topics/programs-and-tools/arangodb-starter/security.md).
...
[read-only mode](../../http/administration.md#update-whether-or-not-a-server-is-in-read-only-mode)
