...
weight: 15
description: >-
  At the very bottom of the ArangoDB database system lies the RocksDB storage engine
archetype: default
---
...
- [`--rocksdb.intermediate-commit-size`](../../core-topics/programs-and-tools/arangodb-server/options.md#--rocksdbintermediate-commit-size)

- [`--rocksdb.intermediate-commit-count`](../../core-topics/programs-and-tools/arangodb-server/options.md#--rocksdbintermediate-commit-count)

- [`--rocksdb.max-transaction-size`](../../core-topics/programs-and-tools/arangodb-server/options.md#--rocksdbmax-transaction-size)
...
[RocksDB Configuration](../../core-topics/programs-and-tools/arangodb-server/options.md#rocksdb)
