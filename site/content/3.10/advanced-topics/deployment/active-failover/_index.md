...
queued [Foxx tasks](../../foxx-microservices/guides/scripts-and-scheduling.md).
...
- Should you be using the [ArangoDB Starter](../../../core-topics/programs-and-tools/arangodb-starter/_index.md) 
