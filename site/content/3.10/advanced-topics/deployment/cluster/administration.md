...
- [`--cluster.min-replication-factor`](../../../core-topics/programs-and-tools/arangodb-server/options.md#--clustermin-replication-factor)
- [`--cluster.max-replication-factor`](../../../core-topics/programs-and-tools/arangodb-server/options.md#--clustermax-replication-factor)

The default replication factor for regular and for system collections is defined
by the following startup options:

- [`--cluster.default-replication-factor`](../../../core-topics/programs-and-tools/arangodb-server/options.md#--clusterdefault-replication-factor)
- [`--cluster.system-replication-factor`](../../../core-topics/programs-and-tools/arangodb-server/options.md#--clustersystem-replication-factor)
...
can be rebalanced using the corresponding buttons in the web [UI](../../../core-topics/programs-and-tools/web-interface/cluster.md).
...
This script has to be executed in the [`arangosh`](../../../core-topics/programs-and-tools/arangodb-shell/_index.md)
