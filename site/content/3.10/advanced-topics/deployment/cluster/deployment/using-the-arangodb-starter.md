...
archetype: default
---
This section describes how to start a Cluster using the [_Starter_](../../../../core-topics/programs-and-tools/arangodb-starter/_index.md)
...
Also see [Security](../../../../core-topics/programs-and-tools/arangodb-starter/security.md) for instructions of how to
...
[`--starter.port` option](../../../../core-topics/programs-and-tools/arangodb-starter/options.md).
...
[Starter options](../../../../core-topics/programs-and-tools/arangodb-starter/options.md).
