...
When deploying using the tool [_Starter_](../../../core-topics/programs-and-tools/arangodb-starter/_index.md)
...
[`--cluster.min-replication-factor` startup option](../../../core-topics/programs-and-tools/arangodb-server/options.md#--clustermin-replication-factor).
...
1. Connect to a _Coordinator_ via [_arangosh_](../../../core-topics/programs-and-tools/arangodb-shell/_index.md)
...
[Foxx services](../../foxx-microservices/_index.md) it is very easy to deploy a data
...
[_Starter_](../../../core-topics/programs-and-tools/arangodb-starter/_index.md), in Docker and in Kubernetes.
