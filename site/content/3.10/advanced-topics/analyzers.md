...
a [JavaScript module](../appendix/javascript-modules/analyzers.md).
...
- [`arangosearch` Views](../core-topics/indexing/arangosearch/arangosearch-views-reference.md) and
  [Inverted indexes](../core-topics/indexing/working-with-indexes/inverted-indexes.md) for details about how
