...
[`--server.maximal-queue-size`](../core-topics/programs-and-tools/arangodb-server/options.md#arangodb-server-options)
...
[Foxx services may override this behavior](../advanced-topics/foxx-microservices/guides/access-from-the-browser.md#cross-origin-resource-sharing-cors).
