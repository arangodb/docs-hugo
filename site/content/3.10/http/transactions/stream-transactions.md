...
[Stream Transactions](../../core-topics/transactions/stream-transactions.md).
...
- Number of documents via the [Collection API](../collections.md#return-number-of-documents-in-a-collection)
- Truncate a collection via the [Collection API](../collections.md#truncate-collection)
- Create an AQL cursor via the [Cursor API](../queries/aql-queries.md#create-cursor)
