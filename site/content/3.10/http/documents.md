...
The above URL schema does not specify a [database name](../getting-started/getting-started/data-model-and-concepts/databases/_index.md#database-names)
...
HTTP header set to the [document revision](../getting-started/getting-started/data-model-and-concepts/documents/_index.md#document-revisions)
...
[Active Failover](../advanced-topics/deployment/active-failover/_index.md#reading-from-followers)
deployment mode.
