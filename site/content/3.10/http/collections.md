              ...
              properties:
                ...
                schema:
                  description: |
                    ...
                    rules documented in [Document Schema Validation](../getting-started/getting-started/data-model-and-concepts/documents/schema-validation.md)
                  type: object
                computedValues:
                  description: |
                  ...
                  items:
                    ...
                    properties:
                      ...
                      expression:
                        description: |
                          An AQL `RETURN` operation with an expression that computes the desired value.
                          See [Computed Value Expressions](../getting-started/getting-started/data-model-and-concepts/documents/computed-values.md#computed-value-expressions) for details.
                        type: string
                      overwrite:
                        description: |
