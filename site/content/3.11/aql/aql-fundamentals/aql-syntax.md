...
- `OPTIONS` –
  ...
  [Graph Traversal](../../core-topics/graphs/traversals/_index.md) /
...
- `PRUNE` –
  [Graph Traversal](../../core-topics/graphs/traversals/_index.md#pruning), FOR operation variant
- `SEARCH` –
...
([`--database.extended-names` startup option](../../core-topics/programs-and-tools/arangodb-server/options.md#--databaseextended-names)),
...
[Attribute names](../../getting-started/getting-started/data-model-and-concepts/documents/_index.md#attribute-names).
