...
{{< info >}}
This feature cannot be used on the server-side, like in [Foxx](../../advanced-topics/foxx-microservices/_index.md), as
...
[`--temp.intermediate-results-path` startup option](../../core-topics/programs-and-tools/arangodb-server/options.md#--tempintermediate-results-path).
