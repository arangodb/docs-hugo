...
This is important to remember when working with [subqueries](../aql-fundamentals/subqueries.md).

[Dynamic attribute names](../aql-fundamentals/data-types.md#objects--documents) are
supported as well:
