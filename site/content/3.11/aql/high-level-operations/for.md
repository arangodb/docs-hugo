...
There is also a special variant for [graph traversals](../../core-topics/graphs/traversals/_index.md):
...
Also see [Combining queries with subqueries](../aql-fundamentals/subqueries.md).
...
[Graph Traversals](../../core-topics/graphs/traversals/_index.md#working-with-named-graphs) (Enterprise Edition only).
{{< /info >}}
...
Also see [Caching of index values](../../core-topics/indexing/working-with-indexes/persistent-indexes.md#caching-of-index-values).
...
See [Multi-dimensional indexes](../../core-topics/indexing/working-with-indexes/multi-dimensional-indexes.md#lookahead-index-hint).
