...
weight: 60
description: >-
  Common errors to make in ArangoDB's query language
archetype: default
---
...
AQL now supports using a semicolon at the end of the query.

## String concatenation

**3.11 does not support String concatenation**
...
[bind parameters](aql-fundamentals/bind-parameters.md) instead whenever possible,
