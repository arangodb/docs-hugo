...
of AQL. The [`POST /_api/document/{collection}`](../../http/documents.md#create-multiple-documents)
...
[optimizer rules](../execution-and-performance/query-optimization.md#optimize-cluster-multiple-document-operations)
for details).
