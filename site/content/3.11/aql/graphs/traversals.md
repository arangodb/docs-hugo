...
- `OPTIONS` **options** (object, *optional*): used to modify the execution of the
  ...
  - **parallelism** (number, *optional*): Optionally parallelize traversal
    ...
    execution.
    {{< tag "ArangoDB Enterprise Edition""ArangoGraph" >}}  - **maxProjections** (number, *optional*): Specifies the number of document
    attributes per FOR loop to be used as projections. The default value is `5`.
    {{< tag "ArangoDB Enterprise Edition""ArangoGraph" >}}  - **weightAttribute** (string, *optional*): Specifies the name of an attribute
