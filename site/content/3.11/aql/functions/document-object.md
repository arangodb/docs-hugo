...
Parse a [document ID](../../getting-started/getting-started/data-model-and-concepts/documents/_index.md#document-identifiers) and
return its individual parts as separate attributes.

This function can be used to easily determine the
[collection name](../../getting-started/getting-started/data-model-and-concepts/collections/_index.md#collection-names) and key of a given document.
