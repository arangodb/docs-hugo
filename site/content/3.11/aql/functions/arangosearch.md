...
when using [inverted indexes](../../core-topics/indexing/working-with-indexes/inverted-indexes.md).
...
See [Information Retrieval with ArangoSearch](../../core-topics/indexing/arangosearch/_index.md) for an
introduction.
...
- **analyzer** (string, _optional_): name of an [Analyzer](../../advanced-topics/analyzers.md).
...
as a nested field for [nested search with Views](../../core-topics/indexing/arangosearch/nested-search.md)
or [inverted indexes](../../core-topics/indexing/working-with-indexes/inverted-indexes.md#nested-search-enterprise-edition).
...
[`collation` Analyzer](../../advanced-topics/analyzers.md#collation)) nor the server language
...
- **analyzer** (string): the name of a [`minhash` Analyzer](../../advanced-topics/analyzers.md#minhash).
...
- **analyzer** (string): the name of an [Analyzer](../../advanced-topics/analyzers.md).
...
Checks whether the [GeoJSON object](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#geojson) `geoJsonA`
...
Return the distance between two [GeoJSON objects](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#geojson),
...
Checks whether the distance between two [GeoJSON objects](../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#geojson)
...
For full examples, see [Search Highlighting](../../core-topics/indexing/arangosearch/search-highlighting.md).
