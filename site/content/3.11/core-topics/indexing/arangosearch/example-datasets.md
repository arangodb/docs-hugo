...
3. Restore the folder `dump` with [arangorestore](../../programs-and-tools/arangorestore/_index.md)
...
2. Unpack the downloaded archive
3. Restore the folder `demo-geo-s2-dump` with [arangorestore](../../programs-and-tools/arangorestore/_index.md)
   into an ArangoDB instance, e.g.
