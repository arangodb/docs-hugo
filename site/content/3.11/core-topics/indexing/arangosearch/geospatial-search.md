...
is indexed by a View. The regular [geospatial index](../working-with-indexes/geo-spatial-indexes.md) can do
...
See [`geojson` Analyzer](../../../advanced-topics/analyzers.md#geojson) for details.
...
[Analyzers](../../../advanced-topics/analyzers.md#geo_s2) for details.
{{< /tip >}}
