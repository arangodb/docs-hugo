...
for the [document keys](../../getting-started/getting-started/data-model-and-concepts/documents/_index.md#document-keys) (`_key` attribute)
...
Every [edge collection](../../getting-started/getting-started/data-model-and-concepts/_index.md#graph-model) also has an 
...
It is possible to add the [array expansion operator](../../aql/advanced-features/array-operators.md#array-expansion)
...
[array expansion operator](../../aql/advanced-features/array-operators.md#array-expansion)):
