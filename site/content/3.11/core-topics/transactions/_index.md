...
Also see:
- [Operation Atomicity](../modeling-data/operational-factors.md#operation-atomicity) for more details on atomicity guarantees
- [Transactional Isolation](../modeling-data/operational-factors.md#transactional-isolation) for more details on isolation guarantees in the single server
