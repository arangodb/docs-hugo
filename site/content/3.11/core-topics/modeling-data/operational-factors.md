...
- Indexes with [indexed array values](../indexing/index-basics.md#indexing-array-values)
...
- Sparse indexes can be smaller than non-sparse indexes, but they can only be
  ...
  (also see [Type and value order](../../aql/aql-fundamentals/type-and-value-order.md)).
...
[Index Basics](../indexing/index-basics.md).
...
See [_Cluster Sharding_](../../advanced-topics/architecture/data-sharding.md) 
...
- Use the `_key` attribute to give documents unique identifiers. The `_key`
  ...
  Some limitations apply, see [Document keys](../../getting-started/getting-started/data-model-and-concepts/documents/_index.md#document-keys).
