...
- `satellites` (array, _optional_):
  An array of collection names that is used to create [SatelliteCollections](../../../advanced-topics/satellitecollections.md)
...
- `data` (object):
  JSON data of vertex.
- `options` (object, _optional_):
  See [collection documentation](../../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md)
...
- `options` (object, _optional_):
  See [`collection.save()` options](../../../getting-started/getting-started/data-model-and-concepts/documents/collection-methods.md#insert--save)
