...
weight: 5
description: >-
  The following examples all use a vertex collection v and an edge collection e
archetype: default
---
The following examples all use a vertex collection `v` and an [edge collection](../../../getting-started/getting-started/data-model-and-concepts/_index.md#graph-model) `e`. The vertex
