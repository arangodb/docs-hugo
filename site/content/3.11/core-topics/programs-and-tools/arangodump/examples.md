...
[database name](../../../getting-started/getting-started/data-model-and-concepts/databases/_index.md#database-names):
...
Collections may be
[created with shard distribution](../../../getting-started/getting-started/data-model-and-concepts/collections/database-methods.md#create)
...
affected. See documentation on [arangorestore](../arangorestore/_index.md) for
