...
menuTitle: ArangoJS - JavaScript Driver
weight: 25
description: >-
  ArangoJS - the JavaScript driver to access ArangoDB from outside the database, primarily with Node.js
archetype: default
---
...
[`@arangodb` module](../../develop/foxx-microservices/reference/related-modules/_index.md#the-arangodb-module)
...
[_errorNum_ error code](../../develop/error-codes-and-meanings.md)
