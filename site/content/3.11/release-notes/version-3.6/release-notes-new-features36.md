...
- a [`maxRuntime` query option](../../aql/how-to-invoke-aql/invocation-with-arangosh#maxruntime)
...
eligible for the OneShard optimization. See [OneShard cluster architecture](../../deployment/deployment-oneshard)
