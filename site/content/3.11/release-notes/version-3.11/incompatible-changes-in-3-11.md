...
2. If your deployment is on a 3.11.x version older than 3.11.11, upgrade to
   ...
   sorting issue in [Resolving known issues with 3.12.0 through 3.12.3](../../../3.12/release-notes/version-3.12/incompatible-changes-in-3-12.md#resolving-known-issues-with-3120-through-3123)
