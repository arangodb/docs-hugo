...
See [Optimizing View and inverted index query performance](../../core-topics/indexing/arangosearch/performance.md#wand-optimization)
for examples.
...
you to create and manage [`search-alias` Views](../../core-topics/indexing/arangosearch/search-alias-views-reference.md).
...
[detailed guide](../../core-topics/indexing/arangosearch/search-alias-views-reference.md#create-search-alias-views-using-the-web-interface).
...
For more information, see the
[detailed guide](../../core-topics/indexing/arangosearch/arangosearch-views-reference.md#create-arangosearch-views-using-the-web-interface).

### Inverted indexes

The web interface now includes the option for creating
[inverted indexes](../../core-topics/indexing/working-with-indexes/inverted-indexes.md) on collections. You can set all the
...
name in backticks or forward ticks (see [AQL Syntax](../../aql/aql-fundamentals/aql-syntax.md#names)):
...
[`PUT /_admin/log/level`](../../http/monitoring.md#modify-and-return-the-current-server-log-level)
