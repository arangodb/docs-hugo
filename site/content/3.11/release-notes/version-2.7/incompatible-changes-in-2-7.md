...
weight: 10
description: >-
  It is recommended to check the following list of incompatible changes before upgrading to ArangoDB 2
archetype: default
---
...
see the [Foxx queues module](../../advanced-topics/foxx-microservices/reference/related-modules/queues.md).
