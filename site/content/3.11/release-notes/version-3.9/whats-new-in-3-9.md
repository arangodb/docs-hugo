...
See:
- [`segmentation` Analyzer](../../advanced-topics/analyzers.md#segmentation)
- [`collation` Analyzer](../../advanced-topics/analyzers.md#collation)
...
[ArangoSearch caching](../../core-topics/indexing/arangosearch/arangosearch-views-reference.md) is only available in the
Enterprise Edition.

See [Optimizing View query performance](../../core-topics/indexing/arangosearch/performance.md)
for examples.
...
See [`UPSERT` Options](../../aql/high-level-operations/upsert.md#indexhint)

### Decay Functions

Added three decay functions to AQL:

- [DECAY_EXP()](../../aql/functions/numeric.md#decay_exp)
- [DECAY_LINEAR()](../../aql/functions/numeric.md#decay_linear)
- [DECAY_GAUSS()](../../aql/functions/numeric.md#decay_gauss)
...
- [COSINE_SIMILARITY()](../../aql/functions/numeric.md#cosine_similarity)
- [L1_DISTANCE()](../../aql/functions/numeric.md#l1_distance)
- [L2_DISTANCE()](../../aql/functions/numeric.md#l2_distance)
...
See the [`FOR` Operation Options](../../aql/high-level-operations/for.md#disableindex) for details.
...
See the [`FOR` Operation Options](../../aql/high-level-operations/for.md#maxprojections) for details.
...
A new [AQL function](../../aql/functions/miscellaneous.md#shard_id) is available which allows you to 
...
[Multi-dimensional Indexes](../../core-topics/indexing/working-with-indexes/multi-dimensional-indexes.md) are an experimental feature.
...
Also see [ArangoDB Server General Options](../../core-topics/programs-and-tools/arangodb-server/options.md#--icu-language).
...
Also see [Logging](../../core-topics/programs-and-tools/arangodb-server/options.md#log).
...
See [ArangoDB Server Options](../../core-topics/programs-and-tools/arangodb-server/options.md#--use-splice-syscall)
for details.
...
Also see [Merging Attributes](../../core-topics/programs-and-tools/arangoimport/examples-csv.md#merging-attributes).
...
See [Overriding data types per attribute](../../core-topics/programs-and-tools/arangoimport/examples-csv.md#overriding-data-types-per-attribute).
...
Also see [_arangobench_ Options](../../core-topics/programs-and-tools/arangobench/_index.md#general-configuration)
...
Also see [_arangodump_ examples](../../core-topics/programs-and-tools/arangodump/examples.md)
...
Also see [_arangorestore_ examples](../../core-topics/programs-and-tools/arangorestore/examples.md).
...
`--fail-on-non-json` which makes [arangovpack](../../core-topics/programs-and-tools/arangovpack/_index.md)
