...
[Encrypted backups](../../core-topics/programs-and-tools/arangodump/examples.md#encryption) are available
...
- basic role support has been added for the LDAP module in the *Enterprise Edition*.
  ...
  Please refer to [LDAP](../../core-topics/programs-and-tools/arangodb-server/ldap.md) for a detailed
  explanation.
