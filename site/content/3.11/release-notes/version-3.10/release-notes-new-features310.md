...
For details, see:
- [`temp` startup options](../../programs-tools/arangodb-server/programs-arangod-options#--tempintermediate-results-path)
- [Executing queries from _arangosh_](../../aql/how-to-invoke-aql/invocation-with-arangosh#spilloverthresholdmemoryusage)
- [Accessing Cursors via HTTP](../../http/aql-query-cursors/aql-query-cursor-accessing-cursors)
