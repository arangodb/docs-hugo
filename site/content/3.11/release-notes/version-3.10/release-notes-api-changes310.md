...
[query spillover feature](release-notes-new-features310#query-result-spillover-to-decrease-memory-usage)
and to [Read from Followers](../../http/documents/document-address-and-etag#read-from-followers):
