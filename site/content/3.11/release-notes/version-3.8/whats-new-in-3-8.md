...
See [`WINDOW` operation](../../aql/high-level-operations/window.md).
...
Also see [Bit functions](../../aql/functions/bit.md).

`BIT_AND()`, `BIT_OR()` and `BIT_XOR()` are also available as aggregate
functions for usage inside [`COLLECT AGGREGATE`](../../aql/high-level-operations/collect.md#aggregation).
...
Also see [ArangoDB Server Query Options](../../core-topics/programs-and-tools/arangodb-server/options.md#--queryallow-collections-in-expressions)
...
See [ArangoSearch Pipeline Analyzer](../../advanced-topics/analyzers.md#pipeline)
...
See [ArangoSearch AQL Analyzer](../../advanced-topics/analyzers.md#aql)

### Geo-spatial queries

Added two Geo Analyzers [`"geojson"`](../../advanced-topics/analyzers.md#geojson)
and [`"geopoint"`](../../advanced-topics/analyzers.md#geopoint) as well as the
following [ArangoSearch Geo functions](../../aql/functions/arangosearch.md#geo-functions)
...
See [ArangoSearch `stopwords` Analyzer](../../advanced-topics/analyzers.md#stopwords)
...
Also see: [AQL `SEARCH` Operation](../../aql/high-level-operations/search.md#search-options)
...
[ArangoDB Server ArangoSearch Options](../../core-topics/programs-and-tools/arangodb-server/options.md#arangosearch).
...
[Encryption at Rest](../../operations/security/encryption-at-rest.md) should see a reduction of CPU
...
[API Changes in 3.8](api-changes-in-3-8.md#endpoints-added).

For the description of a seamless upgrade path see
[Incompatible changes in 3.8](incompatible-changes-in-3-8.md#endpoint-return-value-changes).
...
- [DATE_UTCTOLOCAL()](../../aql/functions/date.md#date_utctolocal)
...
- [DATE_LOCALTOUTC()](../../aql/functions/date.md#date_localtoutc)
...
- [DATE_TIMEZONE()](../../aql/functions/date.md#date_timezone)

  ```aql
  RETURN DATE_TIMEZONE() // [ "Etc/UTC" ]
  ```

- [DATE_TIMEZONES()](../../aql/functions/date.md#date_timezones)
...
Also see [_arangodump_ Threads](../../core-topics/programs-and-tools/arangodump/examples.md#threads).
...
Also see [_arangodump_ Dump Output Format](../../core-topics/programs-and-tools/arangodump/examples.md#dump-output-format).
...
See [ArangoDB Server _Server_ Options](../../core-topics/programs-and-tools/arangodb-server/options.md#--serverongoing-low-priority-multiplier)
