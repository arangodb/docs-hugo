...
Documents are stored in [**collections**](collections/_index.md),
...
Each collection is part of a [**database**](databases/_index.md).
...
[User-specified keys](documents/_index.md#document-keys).
...
in **edge collections**. This [graph](../../../core-topics/graphs/_index.md) model makes ArangoDB classify
...
[graph algorithms](../../../core-topics/graphs/_index.md#supported-graph-algorithms) to find one
...
such as [persistent indexes](../../../core-topics/indexing/working-with-indexes/persistent-indexes.md) and
[geo-spatial indexes](../../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md).
