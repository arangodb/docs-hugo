...
data. They are stored in [collections](../collections/_index.md).
...
See [Collection names](../collections/_index.md#collection-names) and
...
- [Database Methods](database-methods.md)
