...
- [**Graph Database**](../../getting-started/data-model-and-concepts/_index.md#graph-model):
...
- [**Document Database**](../../getting-started/data-model-and-concepts/_index.md#document-model):
...
- [**Data Format**](../../getting-started/data-model-and-concepts/_index.md#documents):
...
- [**Data Storage**](../../../advanced-topics/architecture/storage-engine.md):
...
- [**Hash-based sharding**](../../../advanced-topics/architecture/data-sharding.md):
  Spread bigger datasets across multiple servers using consistent hashing on
  the default or custom shard keys.

- [**Synchronous Replication**](../../../advanced-topics/deployment/cluster/_index.md#synchronous-replication):
...
- [**Active Failover**](../../../advanced-topics/deployment/active-failover/_index.md):
  Run a single server with asynchronous replication to one or more passive
  single servers for automatic failover.

- [**Automatic Failover Cluster**](../../../advanced-topics/deployment/cluster/_index.md#automatic-failover):
...
- [**ArangoSearch for Text Search and Ranking**](../../../core-topics/indexing/arangosearch/_index.md):
...
- [**GeoJSON Support**](../../../core-topics/indexing/working-with-indexes/geo-spatial-indexes.md#geojson):
...
- [**Persistent Indexes**](../../../core-topics/indexing/index-basics.md#persistent-index):
...
- [**Vertex-centric Indexes**](../../../core-topics/indexing/index-basics.md#vertex-centric-indexes):
  Secondary indexes for more efficient graph traversals with filter conditions.

- [**Time-to-Live (TTL) Indexes**](../../../core-topics/indexing/index-basics.md#ttl-time-to-live-index):
  Time-based removal of expired documents.

- [**Geo-spatial Indexes**](../../../core-topics/indexing/index-basics.md#geo-index):
...
{{% comment %}} Experimental feature
- [**Multi-dimensional indexes**](../../../core-topics/indexing/working-with-indexes/multi-dimensional-indexes.md):
  An index type to efficiently intersect multiple range queries, like finding
  all appointments that intersect a time range.
{{% /comment %}}

- [**Background Indexing**](../../../core-topics/indexing/index-basics.md#creating-indexes-in-background):
...
- [**Microservice Support with ArangoDB Foxx**](../../../advanced-topics/foxx-microservices/_index.md):
...
- [**TLS Encryption**](../../../core-topics/programs-and-tools/arangodb-server/options.md#ssl):
...
- [**Web-based User Interface**](../../../core-topics/programs-and-tools/web-interface/_index.md):
...
- **[Backup](../../../core-topics/programs-and-tools/arangodump/_index.md) and [Restore](../../../core-topics/programs-and-tools/arangorestore/_index.md) Tools**:
...
- **[Import](../../../core-topics/programs-and-tools/arangoimport/_index.md) and [Export](../../../core-topics/programs-and-tools/arangoexport/_index.md) Tools**:
