...
- **Skiplist and hash indexes**:
  ...
  [persistent index](../core-topics/indexing/index-basics.md#persistent-index).
...
- **Bundled NPM modules**:
  ...
  [Foxx guide](../advanced-topics/foxx-microservices/guides/using-node-modules.md).
...
- **Fulltext indexes**:
  ...
  It is recommended to use [ArangoSearch](../core-topics/indexing/arangosearch/_index.md) for advanced full-text search capabilities.
...
- **Actions**: Snippets of JavaScript code on the server-side for minimal
  ...
  write [Foxx Microservices](../advanced-topics/foxx-microservices/_index.md), which allow you to define
...
- **Specialized index creation methods in JavaScript API**:
  ...
  [Creating an index](../core-topics/indexing/working-with-indexes/_index.md#creating-an-index).
