...
* *sslProtocol* (optional): which tls version should be used to connect to the url. The default is `4` which is TLS 1.0. See [SSL protocol](../../core-topics/programs-and-tools/arangodb-server/options.md#--sslprotocol) for more options.
