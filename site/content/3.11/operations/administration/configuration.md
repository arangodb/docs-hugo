...
archetype: default
---
The [programs and tools](../../core-topics/programs-and-tools/_index.md) shipped in an
...
respective [Programs & Tools](../../core-topics/programs-and-tools/_index.md) sub-chapter, like the
[ArangoDB Server Options](../../core-topics/programs-and-tools/arangodb-server/options.md).

The [ArangoDB Starter](../../core-topics/programs-and-tools/arangodb-starter/_index.md) works differently
to the other programs and tools. It uses `setup.json` files for its own
[configuration](../../core-topics/programs-and-tools/arangodb-starter/architecture.md#starter-data-directory)
...
tool's option table (e.g. [ArangoDB Server Options](../../core-topics/programs-and-tools/arangodb-server/options.md))
...
connect with an [ArangoShell](../../core-topics/programs-and-tools/arangodb-shell/_index.md) and invoke a
[Transaction](../../core-topics/transactions/_index.md) by calling `db._executeTransaction()`
