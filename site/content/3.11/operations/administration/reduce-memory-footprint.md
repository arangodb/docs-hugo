...
reduce these [RocksDB settings](../../core-topics/programs-and-tools/arangodb-server/options.md#rocksdb):
...
Also see:
- [RocksDB Server Options](../../core-topics/programs-and-tools/arangodb-server/options.md#rocksdb)
...
This option disables the in-memory index [caches](../../core-topics/programs-and-tools/arangodb-server/options.md#cache).
...
The server collects
[statistics](../../core-topics/programs-and-tools/arangodb-server/options.md#--serverstatistics) regularly,
...
[JavaScript](../../core-topics/programs-and-tools/arangodb-server/options.md#javascript) is executed in the ArangoDB
...
Also see the [_arangod_ startup options](../../core-topics/programs-and-tools/arangodb-server/options.md#--serverongoing-low-priority-multiplier).
