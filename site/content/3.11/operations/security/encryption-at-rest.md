...
See [Kubernetes Deployment Resource](../../advanced-topics/deployment/kubernetes/deployment-resource-reference.md#specrocksdbencryptionkeysecretname).
...
[HTTP API](../../http/security.md#encryption-at-rest). This API
