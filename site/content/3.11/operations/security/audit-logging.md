...
[ArangoDB Server Options](../../core-topics/programs-and-tools/arangodb-server/options.md#audit).
...
- `server`: The server name. You can specify a custom name on startup with the
  [`--audit.hostname`](../../core-topics/programs-and-tools/arangodb-server/options.md#--audithostname)
