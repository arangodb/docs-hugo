...
archetype: default
---
The ArangoDB [_Starter_](../../core-topics/programs-and-tools/arangodb-starter/_index.md) supports an automated procedure
to perform upgrades, including rolling upgrades
of a [Cluster](../../advanced-topics/deployment/cluster/_index.md) setup.
