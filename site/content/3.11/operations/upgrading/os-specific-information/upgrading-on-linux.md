...
is a first step to upgrade more complex deployments such as [Cluster](../../../advanced-topics/deployment/cluster/_index.md)
or [Active Failover](../../../advanced-topics/deployment/active-failover/_index.md). 
