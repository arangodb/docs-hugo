...
archetype: default
---
This page will guide you through the process of a manual upgrade of a [_cluster_](../../../advanced-topics/deployment/cluster/_index.md)
...
database will be upgraded (see [`--database.auto-upgrade`](../../../core-topics/programs-and-tools/arangodb-server/options.md#--databaseauto-upgrade))
...
standalone instance in the [_cluster_ deployment preliminary](../../../advanced-topics/deployment/cluster/deployment/_index.md).
