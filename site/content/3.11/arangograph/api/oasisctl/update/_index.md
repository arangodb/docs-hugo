...
* [oasisctl update auditlog](update-audit-log.md)	 - Update an auditlog
* [oasisctl update backup](update-backup.md)	 - Update a backup
* [oasisctl update cacertificate](update-ca-certificate.md)	 - Update a CA certificate the authenticated user has access to
...
* [oasisctl update ipallowlist](update-ip-allowlist.md)	 - Update an IP allowlist the authenticated user has access to
