---
title: HTTP interface for Agency features
weight: 120
description: >-
...
with every request. The authorization header _must_ contain a *superuser JWT Token*; For more information see the [authentication section](authentication.md).
