...
[`--server.authentication`](../core-topics/programs-and-tools/arangodb-server/options.md#--serverauthentication)
...
[`--server.authentication-system-only`](../core-topics/programs-and-tools/arangodb-server/options.md#--serverauthentication-system-only)
...
[ArangoDB starter CLI](../core-topics/programs-and-tools/arangodb-starter/security.md#using-authentication-tokens).
