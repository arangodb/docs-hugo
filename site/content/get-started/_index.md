...
---
New to Arango? Start here. This chapter takes you from "what is this?" to a
running instance with data in it.

## Start with the concepts

If you are not sure yet which product fits your use case, read
[What is Arango?](what-is-arango.md) first. It explains how the products relate
to each other and which one to install.
